...
"silent". That means that the return values of some methods will be
affected by this option, please check the documentation of the methods
available in this class for more details.
...
If the class instance wasn't created as "silent" prints to C<STDERR> all
